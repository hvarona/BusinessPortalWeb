...
@ManagedBean(name="dtListStoreController1")
@ViewScoped
public class ListStoreController1 implements Serializable {
    ...
    public void init() {
        try {
            ...
            try {
                ...
                Logger.getLogger(ListStoreController1.class.getName()).log(Level.SEVERE, null, ex);
            }
